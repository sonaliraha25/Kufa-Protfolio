        ...
        <main>
            ...
            <section id="service" class="services-area pt-120 pb-50">
				<div class="container">
					...
					<div class="row">
                    <?php $db_connect=mysqli_connect('localhost','root','','neptune');
                                  $show_service="SELECT *FROM services WHERE status='active';";
                                  $final_run=mysqli_query($db_connect,$show_service);
                            ?>
                            <?php foreach($final_run as $show): ?>
						<div class="col-lg-4 col-md-6">
							<div class="icon_box_01 wow fadeInLeft" data-wow-delay="0.2s">
                                <i class=" <?=$show['Service_Icon']; ?>"></i>
								<h3><?=$show['Service_Name']; ?></h3>
								<p>
                                <?=$show['Service_Description']; ?>
								</p>
							</div>
