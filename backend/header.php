...
$imp=mysqli_query($db_connect,$image_query);
 $finalimp=mysqli_fetch_assoc($imp)['profile_photo'];
$_SESSION['image']=$finalimp;
        ...
        <div class="app-sidebar">
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        <img src="../assets/backend/image/<?=$_SESSION['image']; ?>">
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="service.php"><i class="material-icons-two-tone">help</i></i>Service</a>
                        <ul class="sub-menu">
                            <li>
